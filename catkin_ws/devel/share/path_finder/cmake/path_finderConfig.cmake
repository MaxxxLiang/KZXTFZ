...
if("TRUE" STREQUAL "TRUE")
  set(path_finder_SOURCE_PREFIX /home/maxliang/Project/CQU/KZXTFZ/Code/hw8-1126/catkin_ws/src/path_finder)
  set(path_finder_DEVEL_PREFIX /home/maxliang/Project/CQU/KZXTFZ/Code/hw8-1126/catkin_ws/devel)
  ...
  set(path_finder_INSTALL_PREFIX /home/maxliang/Project/CQU/KZXTFZ/Code/hw8-1126/catkin_ws/install)
...
if(NOT "/home/maxliang/Project/CQU/KZXTFZ/Code/hw8-1126/catkin_ws/src/path_finder/include " STREQUAL " ")
  set(path_finder_INCLUDE_DIRS "")
  set(_include_dirs "/home/maxliang/Project/CQU/KZXTFZ/Code/hw8-1126/catkin_ws/src/path_finder/include")
  if(NOT " " STREQUAL " ")
    set(_report "Check the issue tracker '' and consider creating a ticket if the problem has not been reported yet.")
  elseif(NOT " " STREQUAL " ")
    set(_report "Check the website '' for information and consider reporting the problem.")
  else()
    set(_report "Report the problem to the maintainer 'yehongkai <yehongkai@todo.todo>' and request to fix the problem.")
  endif()
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'path_finder' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/maxliang/Project/CQU/KZXTFZ/Code/hw8-1126/catkin_ws/src/path_finder/${idir}'.  ${_report}")
    endif()
    _list_append_unique(path_finder_INCLUDE_DIRS ${include})
  endforeach()
endif()

set(libraries "path_finder")
foreach(library ${libraries})
  ...
  elseif(${library} MATCHES "^-")
    ...
    if(NOT path_finder_NUM_DUMMY_TARGETS)
      set(path_finder_NUM_DUMMY_TARGETS 0)
    endif()
    # Make sure the target name is unique
    set(interface_target_name "catkin::path_finder::wrapped-linker-option${path_finder_NUM_DUMMY_TARGETS}")
    while(TARGET "${interface_target_name}")
      math(EXPR path_finder_NUM_DUMMY_TARGETS "${path_finder_NUM_DUMMY_TARGETS}+1")
      set(interface_target_name "catkin::path_finder::wrapped-linker-option${path_finder_NUM_DUMMY_TARGETS}")
    endwhile()
    ...
    list(APPEND path_finder_LIBRARIES "${interface_target_name}")
...
set(path_finder_EXPORTED_TARGETS "")
...
foreach(depend ${depends})
  ...
  _list_append_deduplicate(path_finder_EXPORTED_TARGETS ${${path_finder_dep}_EXPORTED_TARGETS})
endforeach()
